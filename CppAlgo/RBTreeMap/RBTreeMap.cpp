// RBTreeMap.cpp : Defines the entry point for the console application.
//
...
struct Person {
	...
	// Assignment Operator Overloanding
	...
	*/
	...
	/*
		Bitwisw Arithmetic Operator Overloading
	*/
...
int main()
{
	std::cout << "\n### Red-Black Tree Map Test.\n" << std::endl;

	RBTreeMap<Person> map;
