// BinaryArrayMap.cpp : Defines the entry point for the console application.
//
...
#include <chrono>
#include <string>
#include "binary_array_seq_map.h"
...
template BinArraySeqMap<Person>;

int main()
{
	std::cout << "\n### List Sequential Search Map Test.\n" << std::endl;

	BinArraySeqMap<Person> map(100);
	...
	*/
	...
	key.id_ = 3;
	BinArraySeqMap<Person>::MapPos pos;
